...
* trwałość mechaniczną (ilość cykli pracy)
...
Należy zaznaczyć, że przekaźniki i styczniki zasadniczo jest to ten sam typ urządzenia, przyjmuje się rozróżnienie w nazewnictwie - przekaźniki przełączają mniejsze prądy niż styczniki.
